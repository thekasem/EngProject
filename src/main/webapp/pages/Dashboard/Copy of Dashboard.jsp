						...
						<div class="col-md-8 col-sm-6">
							<div class="well">
								<form class="form">
									...
									<div class="input-group text-center">
										<div class="col-md-4">
											<div id="viewaum" style="width: 700px; height: 350px;"></div>
										</div>
									</div>
								</form>
							</div>
...
$(function () {
    ...
    // The speed gauge
    $('#bonanza').highcharts(Highcharts.merge(gaugeOptions, {
        yAxis: {
            min: 0,
            max: 200,
            title: {
    ...
    // The RPM gauge
    $('#archive').highcharts(Highcharts.merge(gaugeOptions, {
        yAxis: {
            min: 0,
            max: 5,
            title: {
